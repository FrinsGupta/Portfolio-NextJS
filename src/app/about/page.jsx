...
export const aboutData = [
  ...
  // },
  {
    ...
    info: [
      {
        title: "Web Developer - Coding-Bits",
            ...
            {aboutData.map((item, itemIndex) => {
              return (
                <div
                  ...
                  } mx-auto cursor-pointer capitalize xl:text-lg relative after:w-8 after:h-[2px] after:bg-white after:absolute after:-bottom-1 after:left-0`}
